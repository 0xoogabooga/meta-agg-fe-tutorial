...
export const useAggregatorsQuote = (to?: Address) => {
  const { isConnected, latestQuote } = useQuoteStream({
    ...
    params: {
      ...
      maxSlippage: '0.5',
      to: to ?? '0x8c2d66577E7CC4CF06c65f14724ee27afB6f7376', // if wallet disconnected it can be undefined. In this case we're getting non-simulated quotes
    },
    enabled: true,
  })
